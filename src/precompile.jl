function _precompile_()
    ...
    precompile(Tuple{DistributionParameters.var"##s40#19",Any,Any,Any,Any,Any,Any,Any,Any})
    precompile(Tuple{DistributionParameters.var"##s40#33",Any,Any,Any,Any,Any,Any,Any,Any,Any,Any,Any})
    ...
    precompile(Tuple{DistributionParameters.var"##s40#32",Any,Any,Any,Any,Any,Any,Any})
    precompile(Tuple{typeof(DistributionParameters.constrain_lkj_factor_quote),Int64,Int64,Int64,Type{Float64},Symbol,Symbol})
    precompile(Tuple{DistributionParameters.var"##s40#4",Any,Any,Any,Any,Any,Any,Any,Any,Any})
end
